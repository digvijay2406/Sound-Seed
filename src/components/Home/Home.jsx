...
<div className="min-h-screen flex items-center justify-left bg-blue-900 ">
  ...
  <input
    class="flex h-10 w-full rounded-md border border-black/30 bg-white px-3 py-2 text-sm placeholder:text-white-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
    type="email"
    placeholder="Email"
  />
  <button
