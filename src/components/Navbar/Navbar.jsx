...
const connectMetamask = async () => {
  ...
  return (
    <div className="relative w-full bg-[#4E01F5]">
          ...
          <ul className="ml-12 inline-flex space-x-8">
            {menuItems.map((item) => (
              <li key={item.name}>
                <Link
                  to={item.to}
                  className="inline-flex items-center text-sm font-bold text-white-00 hover:text-gray-900"
                >
                  {item.name}
                  {/* <span>
...
//           <span className="font-bold text-slate-50">Sound Seed</span>
//         </div>
//         <div className="hidden grow items-start lg:flex">
//           <ul className="ml-12 inline-flex space-x-8">
//             {menuItems.map((item) => (
...
//                 <Link
//                   to={item.to}
//                   className="inline-flex items-center text-sm font-semibold text-slate-50 hover:text-gray-900"
//                 >
//                   {item.name}
